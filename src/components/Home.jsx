...
const Home = () => {
  return (
    <section
      id="home" className='min-h-screen flex justify-center items-center bg-amber-50 text-center'
    >
      <div className='text-center  max-w-3xl'>
        <h1 className='text-3xl md:text-5xl font-bold mb-2 text-blue-400' >Welcome to My Portfolio</h1>
        ...
        <div className="space-x-4">
          <a
            href="/projects"
            className="border px-6 py-3 rounded hover:bg-blue-700 transition" 
          >
            View Projects
          </a>
          <a
